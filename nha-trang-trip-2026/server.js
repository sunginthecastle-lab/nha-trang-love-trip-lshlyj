...
http.createServer(async (req,res)=>{
  if(req.url==="/login" && req.method==="POST"){
    try{
      ...
      return json(res,401,{ok:false,message:"암호가 맞지 않습니다."});
